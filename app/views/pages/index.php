      ...
      <div class="container col-xxl-8 px-4 py-5 hero">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
          <div class="col-10 col-sm-8 col-lg-6">
            <img src="<?php echo URLROOT ?>/img/books.jpg" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
          </div>
          <div class="col-lg-6">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-start">
              ...
              <a href="<?php echo URLROOT; ?>/books/index" type="button" class="btn btn-outline-secondary btn-lg px-4">Ver anúncios</a>
            </div>
          </div>
        </div>
      </div>
